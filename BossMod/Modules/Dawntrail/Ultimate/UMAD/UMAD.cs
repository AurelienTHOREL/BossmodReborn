...
[ModuleInfo(BossModuleInfo.Maturity.WIP, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 1094u, NameID = 7131u, PrimaryActorOID = (uint)OID.BossP1, PlanLevel = 100)]
public sealed class UMAD(WorldState ws, Actor primary) : BossModule(ws, primary, new(100f, 100f), new ArenaBoundsCircle(20f))
{
    ...
    protected override void DrawEnemies(int pcSlot, Actor pc)
    {
        ...
        Arena.Actors(Enemies((uint)OID.GravenImageP1));
    }
}
